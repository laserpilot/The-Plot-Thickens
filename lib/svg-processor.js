...
const fs = require('fs');
const { measurePathLength, generatePasses, lengthToWeight, generateShapeFill } = require('./path-utils');
...
function writeSVGHeader(svgData, stream) {
  ...
  stream.write('  <!-- Generated by plotter-line-thickener -->\n');
